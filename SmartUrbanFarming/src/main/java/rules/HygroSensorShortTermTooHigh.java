...
@Rule(name = "HygroSensorShortTermTooHigh", description = "Create Message Hygrometer Shortterm depending")
public class HygroSensorShortTermTooHigh {
	
	private final String ruleName = "HygroSensorShortTermTooHigh";
	private final String factName = "HygroShortTerm"; // {'HygroShortTerm','HygroMiddleTerm','HygroLongTerm'}
