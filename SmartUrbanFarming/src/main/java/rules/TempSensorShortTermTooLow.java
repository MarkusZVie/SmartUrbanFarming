...
@Rule(name = "TempSensorShortTermTooLow", description = "Create Message Temperature Shortterm depending")
public class TempSensorShortTermTooLow {
	
	private final String ruleName = "TempSensorShortTermTooLow";
