...
@Rule(name = "HygroSensorMiddleTermTooHigh", description = "Create Message Hygrometer Shortterm depending")
public class HygroSensorMiddleTermTooHigh {
	
	private final String ruleName = "HygroSensorMiddleTermTooHigh";
