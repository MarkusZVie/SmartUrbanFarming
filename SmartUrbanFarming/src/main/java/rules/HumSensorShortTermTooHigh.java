...
@Rule(name = "HumSensorShortTermTooHigh", description = "Create Message Humidity Shortterm depending")
public class HumSensorShortTermTooHigh {
	
	private final String ruleName = "HumSensorShortTermTooHigh";
