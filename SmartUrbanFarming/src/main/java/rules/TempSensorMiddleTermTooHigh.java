...
@Rule(name = "TempSensorMiddleTermTooHigh", description = "Create Message Temperature Middle Term depending")
public class TempSensorMiddleTermTooHigh {
	
	private final String ruleName = "TempSensorMiddleTermTooHigh";
