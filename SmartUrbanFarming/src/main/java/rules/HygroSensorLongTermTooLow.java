...
@Rule(name = "HygroSensorLongTermTooLow", description = "Create Message Hygrometer MiddleTerm depending")
public class HygroSensorLongTermTooLow {
	
	private final String ruleName = "HygroSensorLongTermTooLow";
	...
	private final String temporalModifer = "dieses Monat"; //{'heute','diese Woche','diesen Monat'}
