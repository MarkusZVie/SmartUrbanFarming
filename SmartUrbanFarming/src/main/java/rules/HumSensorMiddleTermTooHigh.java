...
@Rule(name = "HumSensorMiddleTermTooHigh", description = "Create Message Humidity Middleterm depending")
public class HumSensorMiddleTermTooHigh {
	
	private final String ruleName = "HumSensorMiddleTermTooHigh";
	private final String factName = "HumMiddleTerm"; 
