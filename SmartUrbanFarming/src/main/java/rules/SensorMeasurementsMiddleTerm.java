...
@Rule(name = "MiddletTermpercentOfMosurementsDone", description = "Create Message if Mesarements are abitary")
public class SensorMeasurementsMiddleTerm {
	
	private final String factName = "MiddletTermpercentOfMosurementsDone";
	
	public SensorMeasurementsMiddleTerm() {
