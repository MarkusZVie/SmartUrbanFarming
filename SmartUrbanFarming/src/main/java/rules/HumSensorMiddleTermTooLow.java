...
@Rule(name = "HumSensorMiddleTermTooLow", description = "Create Message Humidity Middleterm depending")
public class HumSensorMiddleTermTooLow {
	
	private final String ruleName = "HumSensorMiddleTermTooLow";
