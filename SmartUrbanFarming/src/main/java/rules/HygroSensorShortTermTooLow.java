...
@Rule(name = "HygroSensorShortTermTooLow", description = "Create Message Hygrometer Shortterm depending")
public class HygroSensorShortTermTooLow {
	
	private final String ruleName = "HygroSensorShortTermTooLow";
